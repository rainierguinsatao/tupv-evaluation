...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE sections SET course = ?, section = ? WHERE id = ?";
...
<div class="sm:ml-64 mt-14">
    <div class="p-4">
        <h1 class = "font-medium text-gray-600 my-10">
            Editing Information of <span class = "font-semibold text-gray-900"><?php echo $user['course']; ?> - <?= $user['section'];?></span>
        </h1> 
            ...
            <form id="updateSettings" action="" method="post">
                <div class="flex gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="section" id="floating_dept_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value = "<?php echo $user['section']; ?>" />
                    ...
                    <?php
                        ...
                        $result = $stmt->get_result();
                        ?>
                        <select name="course" id="floating_dept_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                            <?php
