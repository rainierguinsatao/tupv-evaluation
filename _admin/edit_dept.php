...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE departmenttbl SET dept = ? WHERE id = ?";
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM departmenttbl WHERE id = ?";
    $stmt = $conn->prepare($sql);
...
<div class="sm:ml-64 mt-14">
    <div class="p-4">
        <h1 class = "font-medium text-gray-600 my-10">
            Editing Information of <span class = "font-semibold text-gray-900"><?php echo $user['dept']; ?></span>
        </h1> 
